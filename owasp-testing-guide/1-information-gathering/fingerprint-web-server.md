...
El objetivo es identificar que tipo y que version web utiliza el objetivo. Es importante como forma de ennumeracion para lo que se pueda conseguir mas adelante. En caso de encontrar versiones desactualizadas es un finding a destacar.

### Tecnicas <a id="summary"></a>

*  B[anner grabbing](https://en.wikipedia.org/wiki/Banner_grabbing)
* Uso de otras herramientas automatizadas
...
#### Sending Malformed Requests <a id="sending-malformed-requests"></a>
...
#### Using Automated Scanning Tools <a id="using-automated-scanning-tools"></a>
