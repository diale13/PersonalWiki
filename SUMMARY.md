...
* [Portswigger Academy](untitled-2/README.md)
  ...
  * [2 - XSS](untitled-2/xxs/README.md)
    ...
    * [Reflected XSS](untitled-2/xxs/reflected-xss/README.md)
      * [2 - Reflected XSS into HTML context with most tags and attributes blocked](untitled-2/xxs/reflected-xss/2-reflected-xss-into-html-context-with-most-tags-and-attributes-blocked.md)
    * [Cheatsheet XSS](untitled-2/xxs/cheatsheet-xss.md)
    * [Lab](untitled-2/xxs/lab/README.md)
      * [REVIEW - Reflected XSS into HTML context with all tags blocked except custom ones](untitled-2/xxs/lab/3-reflected-xss-into-html-context-with-all-tags-blocked-except-custom-ones.md)
      ...
      * [REVIEW - Anchor href attribute with double quotes HTML-encoded](untitled-2/xxs/lab/8-anchor-href-attribute-with-double-quotes-html-encoded.md)
      ...
      * [Reflected XSS into a JavaScript string with angle brackets HTML encoded](untitled-2/xxs/lab/reflected-xss-into-a-javascript-string-with-angle-brackets-html-encoded.md)
  ...
  * [7 - Authentication](untitled-2/7-authentication/README.md)
    ...
    * [2 - Labs username ennumeration & bruteforce](untitled-2/7-authentication/2-labs/README.md)
...
* [Curso android](cursos-no-seguridad-udemy/curso-android/README.md)
  ...
  * [7.1 - Firebase](cursos-no-seguridad-udemy/curso-android/7.1-firebase.md)
  * [7.2 - Registering New Users, Validating Data & the BuilderDesign Pattern](cursos-no-seguridad-udemy/curso-android/7.2-registering-new-users-validating-data-and-the-builderdesign-pattern.md)
  * [7.3 - Shared preferences to save data](cursos-no-seguridad-udemy/curso-android/7.3-shared-preferences-to-save-data.md)
...
* [Node js](cursos-no-seguridad-udemy/node-js/README.md)
  ...
  * [10 - Authentication and Authorization](cursos-no-seguridad-udemy/node-js/10-authentication-and-authorization/README.md)
    ...
    * [7 - Protegiendo rutas](cursos-no-seguridad-udemy/node-js/10-authentication-and-authorization/7-protegiendo-rutas.md)
  ...
  * [11 - Handling and Logging Errors](cursos-no-seguridad-udemy/node-js/11-handling-and-logging-errors/README.md)
    * [1 - Handling Rejected Promises](cursos-no-seguridad-udemy/node-js/11-handling-and-logging-errors/1-handling-rejected-promises.md)
    * [2 - Ahorrando un poco la repeticion](cursos-no-seguridad-udemy/node-js/11-handling-and-logging-errors/2-ahorrando-un-poco-la-repeticion.md)
